...
#define BUTTON_ON (PIND&(1<<PD0)) //macro to Set PIND 0th pin  checks wheather the button is pressed or not.

#define HEATER_ON (PIND&(1<<PD1)) // macro to Set PIND 1st pin it checks wheather the button is pressed or not.
